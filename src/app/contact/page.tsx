      ...
      <section className="contact-section-2 bg-white dark:bg-[#0f172a]! section-padding pt-5">
        ...
        >
          <iframe
            ...
            allowFullScreen
            loading="lazy"
            className="w-full h-56 sm:h-64 md:h-80 lg:h-96 shadow-xl"
          />
        </motion.div>
      </section>
    </DanboxLayout>
...
//                     <h4 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white!">Email Address</h4>
...
//                   <div className="info">
//                     <p className="text-sm sm:text-base md:text-lg lg:text-md font-medium break-all text-gray-900 dark:text-white!">matin_ssus@yahoo.com</p>
//                   </div>
//                   <div className="icon w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-xl sm:rounded-2xl flex items-center justify-center text-2xl sm:text-3xl bg-gray-100 dark:bg-slate-700 group-hover:bg-white dark:group-hover:bg-slate-600 group-hover:text-black transition-all shrink-0">
...
//                   </div>
//                   <div className="title mt-4 sm:mt-6 lg:mt-8">
//                     <h4 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white!">Phone Number</h4>
//                     <span className="text-emerald-500 text-sm sm:text-base lg:text-lg">Call us anytime</span>
//                   </div>
//                 </div>
//                 <div className="bottom-part mt-auto pt-6 sm:pt-8 lg:pt-12 flex items-center justify-between gap-2">
//                   <div className="info">
//                     <p className="text-sm sm:text-base md:text-lg lg:text-md font-medium break-all text-gray-900 dark:text-white!">+880-1865-041206</p>
//                   </div>
//                   <div className="icon w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-xl sm:rounded-2xl flex items-center justify-center text-2xl sm:text-3xl bg-gray-100! dark:bg-slate-700! group-hover:bg-white! dark:group-hover:bg-slate-600! group-hover:text-black! transition-all shrink-0">
//                     <i className="fal fa-arrow-right !font-extrabold text-amber-500" />
//                   </div>
...
//                   </div>
//                   <div className="title mt-4 sm:mt-6 lg:mt-8">
//                     <h4 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white!">Office Address</h4>
//                     <span className="text-amber-500! text-sm sm:text-base lg:text-lg">Visit us anytime</span>
//                   </div>
//                 </div>
//                 <div className="bottom-part mt-auto pt-6 sm:pt-8 lg:pt-12 flex items-center justify-between gap-2">
//                   <div className="info">
//                     <p className="text-sm sm:text-base lg:text-md text-gray-900 dark:text-white!">Vill+Po: Charbata, Upazilla: Subarnachar</p>
//                     <p className="text-sm sm:text-base lg:text-md text-gray-900 dark:text-white!">Dist: Noakhali, Bangladesh</p>
//                   </div>
//                   <div className="icon w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-xl sm:rounded-2xl flex items-center justify-center text-2xl sm:text-3xl bg-gray-100! dark:bg-slate-700! group-hover:bg-white! dark:group-hover:bg-slate-600! group-hover:text-black! transition-all shrink-0">
//                     <i className="fal fa-arrow-right !font-extrabold text-amber-500" />
//                   </div>
...
//       {/* Contact Form Section */}
//       <section className="contact-section-2 bg-white dark:bg-[#0f172a]! section-padding pt-0">
//         <div className="container ">
//           <div className="dark:bg-slate-800/70! p-3 md:p-8 lg:p-20!">
//             <div className="section-title text-center">
//               <span className="sub-title color-2 inline-flex items-center gap-2 px-4 py-2 sm:px-6 sm:py-3 bg-blue-50! dark:bg-blue-950! rounded-full text-sm sm:text-base text-blue-600 dark:text-blue-400!">
//                 <i className="fal fa-pen" /> Write Here
//               </span>
//               <h2 className="mt-char-animation text-2xl sm:text-3xl lg:text-4xl font-bold mt-4 sm:mt-5 text-gray-900! dark:text-white!">Get In Touch</h2>
//             </div>
//             <form
//               id="contact-form"
//               onSubmit={handleSubmit}
