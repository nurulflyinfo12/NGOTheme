                ...
                <div className="single-blog-post post-details">
                  <div className="post-content">
                    ...
                    <Image
                      ...
                      src="/assets/img/news/post5.webp"
                      alt="blog__img"
                    />
                    ...
                    <Image
                      ...
                      className="alignleft"
                      src="/assets/img/news/post6.webp"
                      alt="blog__img"
                    />
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                    ...
                    <li className="single-comment-item">
                      <div className="author-img">
                        <Image
                          ...
                          src="/assets/img/news/author_img2.webp"
                          alt="img"
                        />
                      </div>
                    ...
                    <li className="single-comment-item">
                      <div className="author-img">
                        <Image
                          ...
                          sizes="100vw"
                          style={{ height: "140px", width: "140px" }}
                          src="/assets/img/news/author_img3.webp"
                          alt="img"
                        />
                      </div>
                      <div className="author-info-comment">
                        ...
                        <li className="single-comment-item">
                          <div className="author-img">
                            <Image
                              ...
                              sizes="100vw"
                              style={{ height: "140px", width: "140px" }}
                              src="/assets/img/news/author_img4.webp"
                              alt="img"
                            />
                          </div>
                          <div className="author-info-comment">
