...
export const Volunter = () => {
  const volunteers: {
  ...
  }[] = [
    {
      name: "Shikhon Islam",
      role: "Volunteer",
      image: "/assets/img/volunter/01.webp",
      social: [
    ...
    },
    {
      name: "Amelia Maeve",
      role: "Volunteer",
      image: "/assets/img/volunter/02.webp",
      social: [
        { icon: "fab fa-facebook-f", link: "#" },
        { icon: "fab fa-twitter", link: "#" },
        { icon: "fab fa-vimeo-v", link: "#" },
    ...
    },
    {
      name: "Salman Islam",
      role: "Volunteer",
      image: "/assets/img/volunter/03.webp",
      social: [
        { icon: "fab fa-facebook-f", link: "#" },
        { icon: "fab fa-twitter", link: "#" },
        { icon: "fab fa-vimeo-v", link: "#" },
...
export const VolunteersPage = () => {
  const volunteers: {
    ...
    },
    {
      name: "Samia Jultana",
      role: "Volunteer",
      image: "/assets/img/volunter/09.webp",
      delay: ".3s",
      socialLinks: [
        { platform: "facebook", link: "#", iconClass: "fab fa-facebook-f" },
        { platform: "twitter", link: "#", iconClass: "fab fa-twitter" },
    ...
    },
    {
      name: "Shikhon Islam",
      role: "Volunteer",
      image: "/assets/img/volunter/08.webp",
      delay: ".5s",
      socialLinks: [
        { platform: "facebook", link: "#", iconClass: "fab fa-facebook-f" },
        { platform: "twitter", link: "#", iconClass: "fab fa-twitter" },
