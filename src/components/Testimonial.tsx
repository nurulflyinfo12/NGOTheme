...
export const Testimonial1 = () => {
  const testimonials: {
    ...
    {
      quoteIcon: "/assets/img/testimonial/quote2.webp",
      ...
      clientImage: "/assets/img/testimonial/client.webp",
    ...
    },
    {
      ...
      rating: 5,
      text: "On the other hand we denounce with see righteous indignation and dislike men who arey beguiled and demoralized by leisure moments line desire",
      clientImage: "/assets/img/testimonial/client2.webp",
...
export const Testimonial2 = () => {
  const testimonialsData: {
  ...
  }[] = [
    {
      ...
      img: "/assets/img/testimonial/client-1.webp",
      name: "Shikhon Islam",
      role: "Web Designer",
    },
    {
      stars: 4,
      text: "It uses a dictionary of over 200 Latin words, combined with handful model tence structures, to generate Lorem Ipsum which lo reasonable. The gener Lorem Ipsum done.",
      img: "/assets/img/testimonial/client-2.webp",
      name: "Albert Flores",
      role: "Founder",
    },
    {
      stars: 4,
      text: "It uses a dictionary of over 200 Latin words, combined with handful model tence structures, to generate Lorem Ipsum which lo reasonable. The gener Lorem Ipsum done.",
      img: "/assets/img/testimonial/client-3.webp",
      name: "Guy Hawkins",
      role: "Founder",
    },
    {
...
export const Testimonial3 = () => {
  const testimonials: {
  ...
  }[] = [
    {
      name: "Shikhon Islam",
      role: "Web Designer",
      image: "/assets/img/testimonial/client-1.webp",
      rating: 4,
    ...
    },
    {
      name: "Albert Flores",
      role: "Founder",
      image: "/assets/img/testimonial/client-2.webp",
      rating: 4,
      text: "It uses a dictionary of over 200 Latin words, combined with handful model tense structures, to generate Lorem Ipsum which looks reasonable. The gener Lorem Ipsum done",
    },
    {
      name: "Guy Hawkins",
      role: "Founder",
      image: "/assets/img/testimonial/client-3.webp",
      rating: 5,
      text: "It uses a dictionary of over 200 Latin words, combined with handful model tense structures, to generate Lorem Ipsum which looks reasonable. The gener Lorem Ipsum done",
    },
  ];
