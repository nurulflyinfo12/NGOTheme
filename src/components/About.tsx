            ...
            <div className="lg:col-span-7 space-y-12">
              ...
              >
                ...
                <p>
                  ...
                  মৃতের দাফন ও সৎকার করেছেন এবং এলাকার মানুষকে সংগঠিত করে খাদ্য,
                  বস্ত্র ও আশ্রয়হীন মানুষকে নিঃস্বার্থভাবে সহায়তা প্রদান করেছেন।
                </p>
                <p>
                  তিনি দীর্ঘ ১৫ বছর যাবৎ বাংলাদেশ রেডক্রিসেন্ট সোসাইটির দুর্যোগ
                  ঘূর্ণীঝড় কর্মসূচীর (সিপিপি) তৎকালীন নোয়াখালী সদর থানা টিম
                  লীডার হিসেবে দক্ষতার সাথে দায়িত্ব পালন করেন। সিপিপি'র গ্রাম ও
                  ইউনিয়ন ভিত্তিক স্বেচ্ছাসেবক ইউনিট গঠন ও সফলভাবে পরিচালনা
                  করেছেন।
                </p>
                <p>
                ...
                <p>
                  ...
                  একজন অন্যতম সংগঠক হিসেবে এলাকা মুক্তিযোদ্ধা ইউনিট ও মুক্তিকামী
                  জনগণকে সংগঠিতকরণের ক্ষেত্রে গুরুত্বপূর্ণ অবদান রাখেন।
                </p>
                <p>
                  ...
                  প্রতিষ্ঠাতা জনাব মরহুম মোঃ ফজলুল হক (হক সাহেব) মৃত্যুবরণ করেন।
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600! dark:text-gray-300! leading-relaxed! mb-6!">
                  আজও তাঁর প্রতিষ্ঠিত সংস্থা হাজারো পরিবারের জীবনমান উন্নয়নে কাজ
                  করে যাচ্ছে। তাঁর স্বপ্ন ও আদর্শ আজও আমাদের অনুপ্রেরণা।
                </p>
              </motion.div>
            </div>
          </div>
